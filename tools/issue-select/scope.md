...
I mainly work in TypeScript/JavaScript and Python, more comfortable on the scripting/backend side than deep systems work. This course, I want to get better at using AI tools deliberately, not just accepting output, and at reading unfamiliar codebases quickly. Nothing specific to avoid yet; I'd rather stay open and see what surfaces a real gap.
